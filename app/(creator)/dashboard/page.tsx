...
export default function CreatorDashboardPage() {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(firebaseAuth, async (user) => {
      ...
      try {
        ...
        setItems(productsSnap.docs.map(doc => ({ id: doc.id, ...doc.data() })) as Product[]);
  ...
  const handleDeleteProduct = async (itemId: string) => {
    if (!userId || !confirm("Are you sure you want to delete this product?")) return;
    try {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border mt-6">
              <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Recent Orders</h3>
                <a href="/creator/earnings" className="text-blue-500 text-sm hover:underline">View all</a>
              </div>
